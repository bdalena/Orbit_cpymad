...
for i in range(eseed):
    ...
    if os.path.exists(path+"test_seed{0}/FCCee_heb_modett_orbcor_all_sextuon_it2_seed{0}.tfs".format(i+1)):
    ...
    if os.path.exists(path+"test_seed{0}/FCCee_heb_modett_orbcor_all_sextuon_tune_match_it1_seed{0}.tfs".format(i+1)):
    ...
    cnt=1
    fnameall=path+"test_seed{0}/FCCee_heb_modett_orbcor_all_sextuon_tune_match_it{1}_seed{0}.tfs".format(i+1,cnt)
    
    while os.path.exists(fnameall):
        fnameall=path+"test_seed{0}/FCCee_heb_modett_orbcor_all_sextuon_tune_match_it{1}_seed{0}.tfs".format(i+1,cnt+1)
        cnt+=1
...
print('rms_dist_x_it2 = ',rms_dist_x_it2)
print('rms_dist_y_it2 = ',rms_dist_y_it2)
print('\n')
